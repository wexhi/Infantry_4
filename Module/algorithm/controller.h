...
typedef enum {
    PID_IMPROVE_NONE                = 0b000000000, // 0000 0000
    PID_Integral_Limit              = 0b000000001, // 0000 0001
    PID_Derivative_On_Measurement   = 0b000000010, // 0000 0010
    PID_Trapezoid_Intergral         = 0b000000100, // 0000 0100
    PID_Proportional_On_Measurement = 0b000001000, // 0000 1000
    PID_OutputFilter                = 0b000010000, // 0001 0000
    PID_ChangingIntegrationRate     = 0b000100000, // 0010 0000
    PID_DerivativeFilter            = 0b001000000, // 0100 0000
    PID_ErrorHandle                 = 0b010000000, // 1000 0000
    PID_Integral_Separation         = 0b100000000, // 新增积分分离
} PID_Improvement_e;
